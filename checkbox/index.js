 ...
 */
const divSection = document.createElement('div') //div létrehozása
document.body.appendChild(divSection) //htmlhez hozzáfűzés
divSection.id = 'jssection' //div idjének beállítása
/**
...
divSection.appendChild(jsSimpleButton) //hozzáfűzzük a div-hez
...
divSection.appendChild(jsDoubleButton) //hozzáfűzzük a divhez
